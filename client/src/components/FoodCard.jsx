...
function FoodCard({ data }) {
  ...
  return (
    <div
      className="w-[250px] rounded-2xl border-2 shadow-md overflow-hidden hover:shadow-xl transition-all duration-300 flex flex-col"
      style={{ borderColor: PRIMARY, backgroundColor: CARD_BG }}
    >
      {/* Image & top icons */}
      ...
      <div className="flex-1 flex flex-col p-4">
        ...
        <div className="flex items-center justify-between mt-auto pt-3">
          ...
          <div className="flex items-center border rounded-full overflow-hidden shadow-sm">
            ...
            <button
              className={`px-3 py-2 text-white transition-colors ${cartItems.some((i) => i.id === data._id)
                ? "bg-gray-700"
                : ""
                }`}
              style={{
