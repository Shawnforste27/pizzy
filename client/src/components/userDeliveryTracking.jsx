...
const PRIMARY = "#347928"; // Primary green for polyline
...
export default function UserDeliveryTracking({ orderId, userLocation, shopOrderId }) {
  ...
  return (
    <div className="w-full h-[400px] rounded-2xl overflow-hidden shadow-md mt-3" style={{ backgroundColor: "#FAF7F3" }}>
      <MapContainer center={center} zoom={14} style={{ height: "100%", width: "100%" }}>
        ...
        {/* Route line */}
        <Polyline positions={polylinePath} color={PRIMARY} weight={4} />
      </MapContainer>
    </div>
  );
}
